                ...
                {cfg&&(
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,padding:"0 14px 10px"}}>
                    <div>
                      ...
                      <input type="text" inputMode="numeric" value={cfg.sets}
                        onFocus={e=>e.target.select()}
                        onChange={e=>updateSetsReps("sets",e.target.value.replace(/[^0-9]/g,""))}
                        onBlur={e=>{const v=parseInt(e.target.value);updateSetsReps("sets",v>0?v:1);}}
