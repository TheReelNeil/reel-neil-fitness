        ...
        <>
          <div style={{...card,padding:14,marginBottom:12}}>
            ...
            <div style={{display:"flex",gap:8,marginBottom:8}}>
              ...
              <div style={{flex:1}}>
                <label style={lbl}>Date</label>
                <input style={inp} type="date" value={stepsDate} onChange={e=>setStepsDate(e.target.value)}/>
              </div>
              <div style={{flex:1}}>
                <label style={lbl}>Daily Target</label>
                <input style={inp} type="number" inputMode="numeric" placeholder="10000" value={stepsTarget} onChange={e=>setStepsTarget(e.target.value)} onFocus={e=>e.target.select()}/>
              </div>
            </div>
